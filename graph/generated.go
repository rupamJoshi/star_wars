...
type ComplexityRoot struct {
	...
	Query struct {
		GetSavedResults func(childComplexity int) int
		SearchCharacter func(childComplexity int, name string) int
	}
}
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Character.films":
		if e.complexity.Character.Films == nil {
			break
		}
	...
	case "Query.getSavedResults":
		...
		return e.complexity.Query.GetSavedResults(childComplexity), true

	case "Query.searchCharacter":
		if e.complexity.Query.SearchCharacter == nil {
			break
		}

		args, err := ec.field_Query_searchCharacter_args(ctx, rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Query.SearchCharacter(childComplexity, args["name"].(string)), true
...
func (ec *executionContext) field_Query_searchCharacter_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "name", ec.unmarshalNString2string)
	if err != nil {
...
func (ec *executionContext) _Character_films(ctx context.Context, field graphql.CollectedField, obj *model.Character) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Character_films(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) _Character_Vehicles(ctx context.Context, field graphql.CollectedField, obj *model.Character) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Character_Vehicles(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) _Query_searchCharacter(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Query_searchCharacter(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().SearchCharacter(rctx, fc.Args["name"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_Query_searchCharacter(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Query",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Query_searchCharacter_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) _Query_getSavedResults(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Query_getSavedResults(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().GetSavedResults(rctx)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	for i, field := range fields {
		...
		case "searchCharacter":
			...
			innerFunc := func(ctx context.Context, _ *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Query_searchCharacter(ctx, field)
				return res
			}
		...
		case "getSavedResults":
			...
			innerFunc := func(ctx context.Context, _ *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Query_getSavedResults(ctx, field)
				return res
			}
